...
<p>The AI finds a solution for the maze using Recursive Backtracking algorithm (again, any can be used as long as it they can find a way in a perfect maze) and then starts moving through the map using the generated way. Any obstacles or buffs met are counted for the enemy as they traverse the maze as well.</p>
